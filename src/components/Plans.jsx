                                    ...
                                    <div className="row justify-center">
                                            ...
                                            <div className="single_pricing text-center mt-8 mx-3">
                                                <div className="pricing_title relative inline-block">
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="112" height="110"
                                                         viewBox="0 0 112 110">
                                                        <path className="services_shape" id="Polygon_15"
                                                ...
                                                <div className="pricing_content mt-6">
                                                        <span
                                                            className="pricing_price font-bold text-black text-4xl">$19.00</span>
                                                    <p className="mt-4 leading-9">Lorem ipsum dolor sit am
                                                        consetetur sadi aliquyam erat sed diam voluptua vero eos
                                        ...
                                        <div className="w-full sm:w-9/12 md:w-7/12 lg:w-4/12">
                                            <div className="single_pricing text-center mt-8 mx-3 active">
                                                ...
                                                <div className="pricing_content mt-6">
                                                        <span
                                                            className="pricing_price font-bold text-black text-4xl">$39.00</span>
                                                    <p className="mt-4 leading-9">Lorem ipsum dolor sit am
                                                        consetetur sadi aliquyam erat sed diam voluptua vero eos
                                                        accusam et justo duo dolores </p>
                                                    <a href="" className="main-btn pricing_btn">Choose Plan</a>
                                        ...
                                        <div className="w-full sm:w-9/12 md:w-7/12 lg:w-4/12">
                                            <div className="single_pricing text-center mt-8 mx-3">
                                                ...
                                                <div className="pricing_content mt-6">
                                                        <span
                                                            className="pricing_price font-bold text-black text-4xl">$99.00</span>
                                                    <p className="mt-4 leading-9">Lorem ipsum dolor sit am
                                                        consetetur sadi aliquyam erat sed diam voluptua vero eos
                                                        accusam et justo duo dolores </p>
                                                    <a href="" className="main-btn pricing_btn">Choose Plan</a>
                                    ...
                                    <div className="row justify-center">
                                        ...
                                        <div className="w-full sm:w-9/12 md:w-7/12 lg:w-4/12">
                                            <div className="single_pricing text-center mt-8 mx-3 active">
                                                ...
                                                <div className="pricing_content mt-6">
                                                        <span
                                                            className="pricing_price font-bold text-black text-4xl">$199.00</span>
                                                    <p className="mt-4 leading-9">Lorem ipsum dolor sit am
                                                        consetetur sadi aliquyam erat sed diam voluptua vero eos
                                                        accusam et justo duo dolores </p>
                                                    <a href="" className="main-btn pricing_btn">Choose Plan</a>
                                        ...
                                        <div className="w-full sm:w-9/12 md:w-7/12 lg:w-4/12">
                                            <div className="single_pricing text-center mt-8 mx-3">
                                                ...
                                                <div className="pricing_content mt-6">
                                                        <span
                                                            className="pricing_price font-bold text-black text-4xl">$499.00</span>
                                                    <p className="mt-4 leading-9">Lorem ipsum dolor sit am
                                                        consetetur sadi aliquyam erat sed diam voluptua vero eos
                                                        accusam et justo duo dolores </p>
                                                    <a href="" className="main-btn pricing_btn">Choose Plan</a>
